      ...
      <section id={styles['hero']} className='padding-lr-t2'>
        <div id={styles['hero_contents']}>
          ...
          <p className='margin-b-24 body-regular w-full lg:max-w-[45%] '>
            ¿Listo para sumergirte en un mundo de videojuegos emocionante y diverso? En nuestra plataforma encontrarás
            una selección de los mejores títulos para todas las plataformas y géneros.
            <br />
          </p>
          <div className='flex gap-3'>
            <Button className='primaryButton' type='button' text='Ingresa ahora' link={'/games'} />
            <Button className='secondaryButton' type='button' text='Conocenos' link={'/about'} />
          </div>
        </div>
      </section>
    </>
