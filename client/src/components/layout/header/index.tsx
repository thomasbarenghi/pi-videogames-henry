  ...
  return (
    ...
    >
      ...
      <div className='relative w-8 aspect-square cursor-pointer lg:hidden'>
        <Image src='/img/fi-br-apps.svg' alt='menu' fill onClick={() => handleHamburguer(true)} />
      </div>
      <Button text='Conocenos' type='button' className='secondaryButton hidden lg:flex' link={Routes.ABOUT}></Button>
